  ...
  return (
    ...
    >
      <img
        src={maount}
        alt="mobile bg"
        className=" h-48 w-full absolute -z-10 sm:hidden"
      />
      <h2 className="sm:hidden absolute top-10 font-bold text-2xl max-w-44 left-4">
        Discover the world!
      </h2>
      <div className="container sm:flex justify-between items-center hidden">
        {/* Логотип (слева) */}
        ...
        {/* Навигация */}
        <nav className="flex sm:gap-4 md:gap-14 lg:gap-20 items-center flex-grow justify-center sm:ml-0 ml-[150px]">
          <Link to={"/"}>Home</Link>
          <Link to={"/"}>Map</Link>
        ...
        <div className="flex items-center ml-auto">
          <Link to={"/"} className="me-3 flex items-center">
            <img src={bookmark} alt="bookmark-image" className="w-8 h-8 me-3" />
            Bookmark
          </Link>
          <Link to={"/"} className="border-l-2 border-l-white">
            <img
              src={notifications}
              alt="notifications-image"
              className="w-8 h-8 ms-3 me-4"
            />
          </Link>
          <Link to={"/"} className="flex items-center">
            <img src={user} alt="profile-image" className="w-8 h-8" />
            Profile
          </Link>
        </div>
      </div>
      {/* Кнопка для сайд бара */}
      <div className="container flex sm:hidden justify-start items-start flex-col">
          ...
          <div className="flex flex-col justify-between h-full">
            <div className="flex items-center gap-4 mb-5 justify-between z-10">
              ...
              <button
                ...
                className="p-2 rounded-full hover:bg-gray-800 cursor-pointer"
              >
                <img src={arrowLeft} alt="exit side bar" className="w-6" />
              </button>
            </div>
